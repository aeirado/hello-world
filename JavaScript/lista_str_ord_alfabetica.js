...
3 - Na tabela UTF8 as letras maiúsculas são menores que as minúsculas e as letras acentuadas funcionam da mesma forma, mas são maiores que aquelas não acentuadas
4 - No português o fato de: a. as letras serem acentuadas ou não acentuadas não altera a ordem alfabética; b. as maiúsculas e as minúsculas têm precedência diferente. EX: AaBbCcEe....

Processamento:
1 - o array de caracteres desordenados será composto na mão
2 - não usar a tabela UTF8, construir função que gera uma tabela própria para ordem alfabética no português => usar type {} ou Object
3 - com a tabela posso comparar os caracteres em termos de maior ou menor
4 - para ordenar tenho que percorrer o array de caracteres e comparar os valores encontrados trocá-los qdo i > i+1
5 - o array estará ordenado qdo i > i+1 valer para todos os caracteres 
*/
 
function ordenacao_alfabetica() {
    var tabela_ordenacao = {};
    var letras_ordenadas = "AÁÂÃÀaáâãàBbCcÇçDdEÉÊeéêFfGgHhIÍÎiíîJjKkLlMmNnOÓÔÕoóôõPpQqRrSsTtUÚÛuúûWwVvXxYyZz";
...
//     lista_comp += i;
//     if (i != 'A') {
//         print('{' + lista_comp[j-1] + ' : ' + tabela[lista_comp[j-1]] + '}' + ' é menor que {' + i + ' : ' + tabela[i] + '} ?', (tabela[lista_comp[j-1]] < tabela[i]));
//     }
//     j++;
// }


var lista_letras = ['n','h','B','o','e','j','k','f','A','z','w','ç','ã','G','û','O','p','W','q','Ê','i','ó','H','s','a','r','Â','y','C','b','Í','l','i','d','Û','x','D','À'];
