...
def criaTabuleiro():
    """
    cria uma matriz 8x8 e adiciona uma string vazia a cada posi��o
    da matriz.
    """
    cTabuleiro = []
...
def verificaTamanhoTabuleiro(tabuleiro):
    ...
    se n�o retorna False se tem retorna True.
    """
...
def inicializaTabuleiro(tabuleiro):
    ...
    Uma pe�a � representada por uma tupla que cont�m 2 caracteres, o primeiro indica a a cor da pe�a.
    """
...
def movePeca(tabuleiro, posicaoIni, posicaoFim):
    ...
    Retorna True se for poss�vel mover a pe�a e retorna False caso contr�rio.
    """
    verificaTamanhoTabuleiro(tabuleiro)
...
def imprimeTabuleiro(tabuleiro):
    ...
    """
    Imprime na sa�da padr�o um tabuleiro de maneira que um jogador de xadrez possa entend�-lo.
    """
